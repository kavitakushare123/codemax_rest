                                ...
                                <div class="search-box">
                                    ...
                                    <div class="search-tab-content">
                                        ...
                                        <form action="<?php echo base_url();?>/hotels/hotel_search_results" method="post" id="hotelsearch_form">
                                                                            ...
                                                                            <div class="col-12 col-sm-9 col-md-9">
                                                                                <div class="adult">
                                                                                    <div class="inner-field">
                                                                                        <span class="inner-titles">Adult</span>&nbsp;&nbsp;<label class="guestTitl"><small>(18+ yrs)</small></label>
                                                                                        <div>
                                                                                ...
                                                                                <div class="child">
                                                                                    <div class="inner-field">
                                                                                        <span class="inner-titles">Children</span>&nbsp;&nbsp;<label class="guestTitl"><small>(0-18 yrs)</small></label>
                                                                            ...
                                                                            <div class="specifyAge room1-head" style="display:none">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-9 col-md-9">
                                                                                        <span class="inner-titles">Specify Children ages</span>&nbsp;&nbsp;<label class="guestTitl" style="padding-left:0px;"><small>(0-18 yrs)</small></label>
                                                                                ...
                                                                                <div class="col-12 col-sm-9 col-md-9">
                                                                                    ...
                                                                                    <div class="child">
                                                                                        <div class="inner-field">
                                                                                            ...
                                                                                            &nbsp;&nbsp;<label class="guestTitl"><small>(0-18 yrs)</small></label>
                                                                                            <div>
                                            ...
                                            <select class="form-control validate[required]" name="GuestNationality">
                                                <option value="">Select Country</option>
                                                <?php foreach($countries as $country){?>
                                                    <option value="<?php echo $country->country_code?>"><?php echo $country->country_name?></option>
                                                <?php } ?>
                                            </select>
                                            <!--input type="text" name="country" class="input-text full-width validate[required]" value="" placeholder="" /-->
                                        </div>
                                                            ...
                                                            $("body").on("change", ".childSelected", function (e) {
                                                                optionSelected = $("option:selected", this), valueSelected = this.value, myVal = $(this).parent().parent().parent().parent().data("value"), "0" == valueSelected ? ($(this).parent().parent().parent().siblings(".specifyAge").hide(), $(this).parent().parent().parent().siblings(".specifyAge").children().children().children(".childAge").hide()) : ($(this).parent().parent().parent().siblings(".specifyAge").show(), function () {
                                                                    for (html = [], i = 0; i < valueSelected; i++)
                                                                        varr = "child_age[" + myVal + "][]", html.push('<div class="col-xs-3 col-sm-2 col-md-10 childAge"><div class="inner-field"><select class="yi-select cAgeSelected form-control" name="' + varr + '"><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option> <option value="4">4</option> <option value="5">5</option> <option value="6">6</option> <option value="7">7</option> <option value="8">8</option> <option value="9">9</option> <option value="10">10</option> <option value="11">11</option> <option value="12">12</option> <option value="13">13</option> <option value="14">14</option>  <option value="15">15</option> <option value="16">16</option> <option value="17">17</option> <option value="18">18</option></select> </div></div>')
                                                                ...
                                                                optionSelected = $("option:selected", this), valueSelected = this.value,
                                                                        function () {
                                                                            for (html = [], i = 1; i < valueSelected; i++)
                                                                                divVal = i, roomCnt = i + 1, html.push('<div class="room-container row" data-value="' + divVal + '"> <div class="col-xs-12 col-sm-2 col-md-2"> <label class="roomTitl"> Room <em class="roomCount">' + roomCnt + '</em> : </label> </div><div class="col-xs-12 col-sm-5 col-md-5"> <div class="adult"> <div class="inner-field"> <span class="inner-titles">Adult</span> <select class="yi-select adultSelected form-control" name="adult[]" id="adult_count' + roomCnt + '"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5</option> <option value="6">6</option> </select> </div><label class="guestTitl"><small>(18+ yrs)</small></label> </div></div><div class="col-xs-12 col-sm-5 col-md-5"> <div class="child"> <div class="inner-field"> <span class="inner-titles">Children</span> <select class="yi-select childSelected form-control" name="child[]" id="child_count' + roomCnt + '" data_count="0"> <option value="0">0</option> <option value="1">1</option> <option value="2">2</option>  </select> </div><label class="guestTitl"><small>(0-18 yrs)</small></label> </div></div><div class="clearfix"></div><div class="specifyAge" style="display:none"><div class="row"> <label class="guestTitl">Specify Children ages (0-18 yrs)</label> <div class="specifyChildrenAges"> </div></div></div></div><div class="clearfix"></div>')
