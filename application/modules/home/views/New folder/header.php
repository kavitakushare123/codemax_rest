...
.menu > ul > li a:hover{    color: #0f7bef !important;}
  ...
  <div class="menu">
      <p><a href="<?php echo base_url(); ?>" class="icon">
        <img src="<?php echo base_url(); ?>/public/img/ibz-logo.png" class="img-responsive" alt="logo" style="width:70px">
        IBZ<span>TOURS</span></a></p>
